...
tuple EdgeDSP {
	...
	float flow; 		// [tuples/second] tuples flowing through
...
subject to {
	...
	* ********************************************
	...
	edgeDSP.src not in snkNodes && eligiblePins[edgeDSP.src][nodeRES_U] == 1)
		connectivity_one:
	...
	edgeDSP.dst not in srcNodes && eligiblePins[edgeDSP.dst][nodeRES_V] == 1)
		connectivity_two:
